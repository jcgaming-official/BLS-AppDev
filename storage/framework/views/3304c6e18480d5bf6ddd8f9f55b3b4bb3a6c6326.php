        ...
        <div class="container">
            <div class="row">
                ...
                <div class="offset-md-7 col-md-2">
                    <a class="add-new" href="<?php echo e(route('books')); ?>">All Books</a>
                </div>
            </div>
            <div class="row">
                <div class="offset-md-3 col-md-6">
                    <form class="yourform" action="<?php echo e(route('book.store')); ?>" method="post" autocomplete="off">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Book Name" name="name" value="<?php echo e(old('name')); ?>" required>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ll\resources\views/book/create.blade.php ENDPATH**/ ?>